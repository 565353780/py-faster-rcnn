...
class pascal_voc(imdb):
    def __init__(self, image_set, year, use_diff=False):
        ...
        if my_train_mode:
            self._data_path = os.path.join('E:/chLi/pytorch-faster-rcnn/data/' + data_name + '/')
        else:
    ...
    """
        if my_train_mode:
            return 'E:/chLi/pytorch-faster-rcnn/data'
        else:
